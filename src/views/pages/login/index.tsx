...
const LoginPage: NextPage<TProps> = () => {
    ...
    const onSubmit = (data: FormData) => {
        ...
        if (!Object.keys(errors)?.length) {
            login({ ...data, rememberMe: rememberPassword })
        }
    }
    ...
    return (
        <Grid container component="main" sx={{ height: '100vh', bgcolor: theme.palette.background.paper }}>
            ...
            <Grid
                ...
                md={7}
                sx={{
                    backgroundImage: 'url(https://gcs.tripi.vn/public-tripi/tripi-feed/img/474077uYd/4k-wallpapers_105907099.jpg)',
                        ...
                        <Grid container>
                            ...
                            <Grid item>
                                <Box sx={{ display: "flex" }}>
                                    ...
                                    <Link href="/register" style={{ color: theme.palette.primary.main }}  >{"Register"}</Link>
                                </Box>
                            </Grid>
                        </Grid>
                    </form>
